%% Convergence performance for unconstrained TMM
clear all;
%% system matrices
...
x0 = 1*rand(2*d,1);
num_steps = 200;
% Run algorithm 1 (without projection)
...
xlim([0, 200]);
ylim([1e-8, 1e2]);
legend('Triple momentum method', 'Theoretical bound','fontsize', 20);
